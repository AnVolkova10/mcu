    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="mb-8">
        <h1 className="text-3xl sm:text-4xl font-black text-white tracking-wider flex items-center gap-3 font-title uppercase">
          ...
          <span>MCU CHARACTER DOSSIERS & FACTIONS</span>
        </h1>
        <p className="text-sm text-zinc-400 mt-1 font-din">
          Comprehensive database of Marvel Cinematic Universe heroes, villains, and factions organized by team affiliations (Avengers, Hatut Zeraze, S.H.I.E.L.D., K'un-Lun) and origin realms.
        </p>
      </div>
      ...
      <div className="bg-[#141414] p-5 rounded-xl border border-[#27272a] shadow-xl mb-8 space-y-4">
        ...
        <div className="relative">
          ...
          <input
            ...
            placeholder="Search by character, faction (Hatut Zeraze, Avengers, K'un-Lun) or realm (Wakanda, Asgard)..."
        ...
        <div>
          <div className="flex items-center gap-1.5 text-xs font-bold text-zinc-400 uppercase tracking-wider mb-2 font-title">
            ...
            <span>FILTER BY FACTION / GROUP:</span>
          </div>
          ...
          return (
            ...
            >
              ...
              <div className="pt-3 border-t border-[#242424] flex items-center justify-between text-xs font-din">
                <span className="text-zinc-500 text-[11px] uppercase font-semibold">DOSSIER</span>
